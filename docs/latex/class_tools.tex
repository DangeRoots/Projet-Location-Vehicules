...
Utilitaires. Cette classe fournit un certain nombre de fonctions utilitaires telles que la transformation de chaînes de caractères en majuscules 
...
\begin{DoxyParams}{Paramètres}
{\em data,une} & chaîne de caractères \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Renvoie}
...
\begin{DoxyParams}{Paramètres}
{\em val,une} & chaîne de caractères \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Renvoie}
...
\begin{DoxyParams}{Paramètres}
{\em chaine,une} & chaîne de caractères \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Renvoie}
none 
