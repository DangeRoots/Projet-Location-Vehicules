...
\begin{DoxyParams}{Paramètres}
{\em date,\hyperlink{class_c_date}{CDate},une} & date \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Paramètres}
{\em jour,entier,le} & jour \\
\hline
{\em mois,entier,le} & mois \\
\hline
{\em annee,entier,l'année} & \\
\hline
\end{DoxyParams}
...
un entier 
\end{DoxyReturn}
\hypertarget{class_c_date_ab821249870921bdffedb18da199f5891}{
\index{CDate@{CDate}!GetStrMois@{GetStrMois}}
\index{GetStrMois@{GetStrMois}!CDate@{CDate}}
\subsubsection[{GetStrMois}]{\setlength{\rightskip}{0pt plus 5cm}std::string CDate::GetStrMois (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{class_c_date_ab821249870921bdffedb18da199f5891}
...
\begin{DoxyParams}{Paramètres}
{\em date,objet} & Date, la date à comparer \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Renvoie}
bool 
\end{DoxyReturn}
\hypertarget{class_c_date_a8fcb0b615460c60f3f4db15eb197011b}{
\index{CDate@{CDate}!operator$<$=@{operator$<$=}}
\index{operator$<$=@{operator$<$=}!CDate@{CDate}}
\subsubsection[{operator$<$=}]{\setlength{\rightskip}{0pt plus 5cm}bool CDate::operator$<$= (
\begin{DoxyParamCaption}
...
\label{class_c_date_a8fcb0b615460c60f3f4db15eb197011b}


Infériorité égalité dates. 
...
bool 
\end{DoxyReturn}
\hypertarget{class_c_date_ac0553a16a486d0ec1c375846821ef460}{
\index{CDate@{CDate}!operator$>$=@{operator$>$=}}
\index{operator$>$=@{operator$>$=}!CDate@{CDate}}
\subsubsection[{operator$>$=}]{\setlength{\rightskip}{0pt plus 5cm}bool CDate::operator$>$= (
\begin{DoxyParamCaption}
...
\label{class_c_date_ac0553a16a486d0ec1c375846821ef460}


Supériorité égalité dates. 
...
void 
\end{DoxyReturn}
\hypertarget{class_c_date_a00a40e811874a7b1cca4461cbcee1356}{
\index{CDate@{CDate}!today@{today}}
\index{today@{today}!CDate@{CDate}}
\subsubsection[{today}]{\setlength{\rightskip}{0pt plus 5cm}{\bf CDate} CDate::today (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{class_c_date_a00a40e811874a7b1cca4461cbcee1356}
